...
+ ADALM-PLUTO - uses the PlutoSDR source block that requires some steps for installing on a Linux system, and needs both the sample rate and the tuning frequency changed. For details see the [Spectrometer Source Block Settings page here]({{ site.baseurl }}/Spectrometer_sourceblock_settings).
