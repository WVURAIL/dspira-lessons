...
The fact that the end product and much of the guts of GNU Radio is in Python implied we can exploit the standard library of python or our own scripts to test out several things. We shall look into making any arbitrary wave form. This is useful for testing systems designed in GNU Radio
...
[^stream]: For a technical explaination of the block [click here](https://wiki.gnuradio.org/index.php/Stream_Tags)
...
> Use mulitple signal generators from section [1.3.3](#133-a-general-waveform-generator) to add and subtract and multiply to form new waveforms.  We'll add the examples here!
