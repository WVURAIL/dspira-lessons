...
layout: post
date:   2020-05-25
title: Somebody motorised a horn telescope
summary:  An independent Instructables build that borrowed the DSPIRA horn design and put it on a motorised mount
...
antenna, the author is direct about where it came from:

> So, the first part of the project was making an antenna to improve the
