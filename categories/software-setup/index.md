...
* [**Simple Spectrometer**](https://wvurail.org/dspira-lessons/Simple_Spectrometer) - Includes an introduction to *GNU Radio* with some basic lessons in DSP, and steps on how to build a simple spectrometer in *GNU Radio*.
