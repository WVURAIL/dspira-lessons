...
<img alt="Jansky's rotating antenna: a long white girder framework on wheels that rides a circular ground track, more like scaffolding than a dish" class="img-circle" style="float:right;" src="/dspira-lessons/images/JanskyHerman.jpg">
...
<img alt="Green Bank Telescope at dusk: a giant white off-axis dish atop a lattice tower, dwarfing a smaller dish telescope in the distance" class="img-circle" style="float:left;" src="/dspira-lessons/images/GBTHerman.jpg">

The DSPIRA program truly encompasses the full nature of this symbiotic relationship between Science and Engineering.  The fact that YOU can now build a simple radio horn telescope to receive and decipher astronomical radio signals is amazing.  The *Receiver Electronics* and *Software Setup* modules on this website take you through getting the instrument ready.   
...
<img alt="Celestial sphere centered on Earth, gridded by right ascension hours and declination degrees, with the celestial equator in red and ecliptic in green" src="/dspira-lessons/images/Celestial_Sphere_-_Equatorial_Coordinate_System.png" align="left" width="120px"/> - If you are starting from ground zero in this discipline, then you will need to develop some basic tools, whether it is where to look in your hometown skies, through to understanding what “electromagnetic radiation” is, how “radio” fits and what we can learn from it.

[Go to "Basic Tools" Activities]({{ site.baseurl }}/ObserveTools){: .button}

### 2. Measuring the Earth's Speed around the Sun
<img alt="" src="/dspira-lessons/images/EarthSun.png" align="left" width="150px"/> - The contains a traditional physics/astronomy examination of gravity to predict the speed of the Earth around the Sun. It also looks at the Doppler effect for measuring relative radial motion.  This all leads to using the radio horn telescope to observationally verify the speed of the Earth around the Sun by using the center of the Milky Way as a reference point.

[Go to "Earth Around Sun" Activities]({{ site.baseurl }}/EarthAroundSun){: .button}
 
### 3. The Milky Way Galaxy 
<img alt="Artist's view of the Milky Way face-on, showing its central bar and labeled spiral arms" src="/dspira-lessons/images/MWG.png" align="left" width="150px"/> - The radio horn telescope is best at detecting neutral hydrogen in the Milky Way Galaxy.  This topic takes on a set of lessons to familiarize you, or your students, with the basic nature of the Milky Way, with emphasis on understanding the rotational aspects of our home galaxy through modeling. 

[Go to Milky Way Activities]({{ site.baseurl }}/Astro_MWG){: .button}
 
### 4. Determining a Velocity Curve of the Milky Way Galaxy 
<img alt="Neutral hydrogen velocity plotted against galactic longitude from the Leiden/Dwingeloo and IAR HI surveys — the map the horn data builds toward" src="/dspira-lessons/images/HIMap.png" align="left" width="170px"/>
